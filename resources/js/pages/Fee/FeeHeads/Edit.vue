...
const breadcrumbItems: BreadcrumbItem[] = [
    ...
    { title: 'Edit', href: `/fee/heads/${props.feeHead.id}/edit` },
];

const form = reactive({
    name: props.feeHead.name,
    code: props.feeHead.code,
    description: props.feeHead.description || '',
    category: props.feeHead.category,
    default_frequency: props.feeHead.default_frequency,
    is_recurring: props.feeHead.is_recurring ?? true,
    is_active: props.feeHead.is_active,
    is_optional: props.feeHead.is_optional,
    sort_order: props.feeHead.sort_order || 1,
});
...
const submitForm = () => {
    ...
    router.put(route('fee.heads.update', props.feeHead.id), {
        ...form,
        sort_order: form.sort_order ? Number(form.sort_order) : 0,
    }, {
        onSuccess: () => {
            isSubmitting.value = false;
            alert.success('Fee head updated successfully!');
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        <div class="space-y-2">
                            ...
                            <Input
                                ...
                                placeholder="0"
                            />
                            <p class="text-xs text-muted-foreground mt-1">Changing order will shift other fee heads</p>
                        </div>
