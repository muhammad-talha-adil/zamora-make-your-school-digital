...
const breadcrumbItems: BreadcrumbItem[] = [
    ...
    { title: 'Batch Print', href: '#' },
];
</script>

<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        <Head title="Batch Print Vouchers" />
        ...
        <div class="Print-container p-4 md:p-6">
            ...
            <div class="space-y-8">
                <div
                    ...
                    :key="voucher.id"
                    class="max-w-3xl mx-auto bg-white border-2 border-gray-800 rounded-lg p-6 print:border-none print:p-0 print:break-after-page"
                >
                    <!-- Header -->
