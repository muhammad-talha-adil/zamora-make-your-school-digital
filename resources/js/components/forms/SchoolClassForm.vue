    ...
    <Dialog v-model:open="open">
        <DialogTrigger as-child>
            <Button
                ...
                :size="props.size"
                :class="props.schoolClass ? 'min-h-8 border-sky-200 text-sky-700 hover:bg-sky-50 hover:text-sky-800 dark:border-sky-800 dark:text-sky-300 dark:hover:bg-sky-950/40 dark:hover:text-sky-200' : ''"
            >
